...
namespace Pathfinding
{
    ...
    public class ABPath : Path
    {
        ...
        public static ABPath FakePath(List<Vector3> vectorPath, List<GraphNode> nodePath = null)
        {
            ...
            path.completeState = pathIsDone.Complete;
        ...
        protected override void Initialize()
        {
            ...
            if (CompleteState == pathIsDone.Complete) return;
            ...
            if (pathHandler.heap.isEmpty)
            {
                if (calculatePartial)
                {
                    CompleteState = pathIsDone.Partial;
        ...
        void CompleteWith(GraphNode node)
        {
            ...
            CompleteState = pathIsDone.Complete;
        }
        ...
        protected override void CalculateStep(long targetTick)
        {
            ...
            while (CompleteState == pathIsDone.NotCalculated)
            {
                searchedNodes++;
            ...
            if (CompleteState == pathIsDone.Complete)
            {
                Trace(currentR);
            }
