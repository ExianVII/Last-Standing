    ...
    public class PathProcessor
    {
        ...
        void CalculatePathsThreaded(PathHandler pathHandler)
        {
            ...
            try
            {
				...
				profilingSampler.Begin();
                    ...
                    if (path.CompleteState == pathIsDone.NotCalculated)
                    {
                        ...
                        while (path.CompleteState == pathIsDone.NotCalculated)
                        {
        ...
        IEnumerator CalculatePaths(PathHandler pathHandler)
        {
            ...
            while (true)
            {
                ...
                if (p.CompleteState == pathIsDone.NotCalculated)
                {
                    ...
                    while (p.CompleteState == pathIsDone.NotCalculated)
                    {
                        // Do some work on the path calculation.
                        // The function will return when it has taken too much time
                        // or when it has finished calculation
                        ...
                        // Improves latency
                        if (p.CompleteState != pathIsDone.NotCalculated) break;
