...
namespace Pathfinding
{
    ...
    public abstract class Path : IPathInternals
    {
        ...
        protected pathIsDone completeState;
        ...
        /// </summary>
        public pathIsDone CompleteState
        {
            ...
            protected set
            {
                ...
                lock (stateLock)
                {
                    ...
                    if (completeState != pathIsDone.Error) completeState = value;
                }
            }
        }
        ...
        /// </summary>
        public bool error { get { return CompleteState == pathIsDone.Error; } }
        ...
        public void Error()
        {
            CompleteState = pathIsDone.Error;
        }
        ...
        protected virtual void Reset()
        {
            ...
            immediateCallback = null;
            errorLog = "";
            completeState = pathIsDone.NotCalculated;
